        ...
        stage('Deploy to k8s'){
            steps{
                script{
                    ...
                    kubernetesDeploy configs: 'deployment.yaml,service.yaml', kubeConfig: [path: ''], kubeconfigId: 'my-kubeconfig3', secretName: '', ssh: [sshCredentialsId: '*', sshServer: ''], textCredentials: [certificateAuthorityData: '', clientCertificateData: '', clientKeyData: '', serverUrl: 'https://']
                }
            }
        }
    }
